...
// Declaration du descripteur du FIFO de réception et de la taille
int8_t fifoRX[16];
S_fifo descrFifoRX;
// *****************************************************************************
// *****************************************************************************
...
void __ISR(_UART_1_VECTOR, ipl2AUTO) _IntHandlerDrvUsartInstance0(void)
{
    ...
    // Traitement des interruptions de réception
    ...
    {         
        ...
        {
            dataAvailable = PLIB_USART_ReceiverDataIsAvailable(USART_ID_1);
            if (dataAvailable)
            {
